...
import { IJsBridgeMessagePayload, IJsonRpcRequest } from '@chargerwallet/cross-inpage-provider-types';
...
function injectedProviderReceiveHandler(payload: IJsBridgeMessagePayload, bridge?: JsBridgeBase) {
  ...
  const providerHub = bridge?.providersHub || window.$chargerwallet;
